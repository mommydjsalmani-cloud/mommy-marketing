...
export default function Header() {
  ...
  return (
    <header className="bg-gray-800 bg-opacity-90 backdrop-blur-sm shadow-sm sticky top-0 z-50 border-b border-gray-700">
          ...
          <ul className="hidden md:flex space-x-6 lg:space-x-8">
            {navLinks.map((link) => (
              <li key={link.href}>
                <Link
                  href={link.href}
                  className="text-gray-300 hover:text-accent transition-colors font-medium uppercase text-sm tracking-wide"
                >
                  {link.label}
                </Link>
              </li>
            ...
            <ul className="space-y-3">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="block text-gray-300 hover:text-accent transition-colors font-medium uppercase text-sm tracking-wide py-2"
